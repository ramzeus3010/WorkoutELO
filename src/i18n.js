...
const en = {
  ...
  "bot.strengthLine": "Strength *{strength}* · this week *{effort}* effort over {sessions} {unit}",
  "bot.movedUp": "📈 Up to *#{rank}*, past {passed}.",
  "bot.and": " and ",
...
const ru = {
  ...
  "log.repsShort": "повт.",
  "log.setN": "Подх. {n}",
  "log.addSet": "Добавить подход + отдых",
  ...
  "board.you": "(вы)",
  "board.share": "Поделиться результатом",
  "board.copied": "Скопировано!",
  "board.addFriend": "Добавить результат друга",
  ...
  "exp.range.4w": "Последние 4 недели",
  "exp.range.12w": "Последние 3 месяца",
  "exp.range.all": "Всё",
  ...
  "bot.strengthLine": "Сила *{strength}* · на этой неделе *{effort}* активности за {sessions} {unit}",
  "bot.movedUp": "📈 Поднялся на *#{rank}*, обойдя: {passed}.",
  "bot.and": " и ",
